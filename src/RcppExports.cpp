...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(integrate_sys_const(derivs, recfun, init, duration, step_size, start, atol, rtol));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type atol(atolSEXP);
    Rcpp::traits::input_parameter< double >::type rtol(rtolSEXP);
    rcpp_result_gen = Rcpp::wrap(integrate_sys_adapt(derivs, recfun, init, duration, step_size, start, atol, rtol));
    return rcpp_result_gen;
END_RCPP
}
