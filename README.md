...
# M is defined internally as std::sqrt(sys_dim)
...
```r
# this illustrates using a custom observer
# the animation is generated by the knitr package
f = function(x, t) image(matrix(x, M, M), asp = 1, axes = F,
...
<video   controls loop><source src="README_files/figure-html/unnamed-chunk-9-.webm" />video of chunk unnamed-chunk-9</video>
